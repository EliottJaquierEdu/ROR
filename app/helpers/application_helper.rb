module ApplicationHelper
  def navigation_links
    ...
    links << { path: school_classes_path, icon: 'bi-building', text: 'School Classes' }
    ...
    # Examinations - accessible to all authenticated users
    links << { path: examinations_path, icon: 'bi-clipboard-check', text: 'Examinations' }
    
    # Grades - accessible to all authenticated users (individual access controlled in controller)
    links << { path: grades_path, icon: 'bi-award', text: 'Grades' }
