...
class SchoolClassesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create scool_class" do
    assert_difference("SchoolClass.count") do
      post scool_classes_url, params: { scool_class: { master: @scool_class.master, moment_id: @scool_class.moment_id, name: @scool_class.name, room_id: @scool_class.room_id, uid: @scool_class.uid } }
    end
  ...
  test "should update scool_class" do
    patch scool_class_url(@scool_class), params: { scool_class: { master: @scool_class.master, moment_id: @scool_class.moment_id, name: @scool_class.name, room_id: @scool_class.room_id, uid: @scool_class.uid } }
